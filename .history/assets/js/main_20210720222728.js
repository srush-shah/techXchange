...
$(".purchase-btn").click(function () {
  if ($current_product in $products) {
    var url =
      "https://colorlib.com/wp/template/" + $current_product + "/#pricing";
...
function switcher_viewport_buttons() {
  if (
    ...
    $products[$current_product].responsive === 0
  ) {
    $(".desktop-btn").click();
    $viewportButtons
      .addClass("disabled")
